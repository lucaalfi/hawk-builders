...
import MoreFacts from "../components/moreFactsTailwind.jsx";
  ...
  render(){
    return(
      <div>
        ...
        <MoreFacts message1="Brick laying" message2="Electrical" message3="Painting"/>
        
        
        <div className="flex flex-col p-2 justify-center items-center" id="Projects">
          <h1 className="text-5xl m-1"> Projects </h1> 
          <Fade triggerOnce keyframes={up} delay="0">
            <div className="flex justify-center items-center">         
              <div className="flex justify-center items-center">
                <div className="flex justify-evenly flex-wrap  w-9/12">
            ...
            <div className="m-5">
              <a className="text-xl rounded-3xl bg-rose-900 text-white p-3 mt-6 shadow-black shadow-lg transition duration-500 hover:shadow-none" href="/projects"> View More </a> 
            </div>
          </Fade>
        </div>
